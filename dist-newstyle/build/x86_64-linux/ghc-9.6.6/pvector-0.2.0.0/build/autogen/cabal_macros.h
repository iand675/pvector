...
/* package pvector-0.2.0.0 */
#ifndef VERSION_pvector
#define VERSION_pvector "0.2.0.0"
#endif /* VERSION_pvector */
#ifndef MIN_VERSION_pvector
#define MIN_VERSION_pvector(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_pvector */
...
#define CURRENT_PACKAGE_KEY "pvector-0.2.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "pvector-0.2.0.0-inplace"
