...
-- at runtime using the environment variable pvector_bindir.
...
-- environment variable pvector_libdir.
...
-- using the environment variable pvector_dynlibdir.
...
-- runtime using the environment variable pvector_datadir.
...
-- using the environment variable pvector_sysconfdir.
...
libdir     = "/home/ubuntu/.cabal/lib/x86_64-linux-ghc-9.6.6/pvector-0.2.0.0-inplace-test-pvector"
dynlibdir  = "/home/ubuntu/.cabal/lib/x86_64-linux-ghc-9.6.6"
datadir    = "/home/ubuntu/.cabal/share/x86_64-linux-ghc-9.6.6/pvector-0.2.0.0"
libexecdir = "/home/ubuntu/.cabal/libexec/x86_64-linux-ghc-9.6.6/pvector-0.2.0.0"
sysconfdir = "/home/ubuntu/.cabal/etc"

getBinDir     = catchIO (getEnv "pvector_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "pvector_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "pvector_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "pvector_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "pvector_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "pvector_sysconfdir") (\_ -> return sysconfdir)
